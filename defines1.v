...
// Maximum number of bits that can be sent/received at once
// Use SPI_MAX_CHAR for fine-tuning the exact number when using
// SPI_MAX_CHAR_128, SPI_MAX_CHAR_64, SPI_MAX_CHAR_32, SPI_MAX_CHAR_24, SPI_MAX_CHAR_16, SPI_MAX_CHAR_8
...
`ifdef SPI_MAX_CHAR_8
  `define SPI_MAX_CHAR          8 // can be set to 128
